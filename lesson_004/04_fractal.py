...
def draw_branches_recursion2(start_point, _length, _angle=0):
    if _length < 10:
        return
    v1 = sd.get_vector(start_point=start_point, angle=_angle + 30, length=_length, width=2)
    v1.draw(color=(138, 102, 66))
    v2 = sd.get_vector(start_point=start_point, angle=_angle - 30, length=_length, width=2)
    v2.draw(color=(138, 102, 66))
    next_point = v1.end_point
